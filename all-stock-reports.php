                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">All Stocks Reports</h5>
                                                            ...
                                                            <table class="table table-striped table-bordered nowrap">
                                                                <thead>
                                                                    <tr>
																				...
																				<th style="width=30;text-align:center;" >Product kg Value</th>  	
																...
																<?php
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/update-stock-details.php?stock-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/all-stock-reports.php?del_stock_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
